  ...
  describe ".with_meta" do
    ...
    context "insert" do
      ...
      it "loads meta with stringified keys when hash with symbolized keys is provided" do
        Logidze[:sequel].with_meta(meta.transform_keys(&:to_sym)) do
          expect(subject.reload.meta).to eq meta
        end
      end
      ...
      it "handles block" do
        ...
        Logidze[:sequel].with_meta(meta, &block)
      ...
      it "handles nil" do
        ...
        Logidze[:sequel].with_meta(nil, &block)
      ...
      it "handles nested blocks" do
        Logidze[:sequel].with_meta(meta) do
          ...
          Logidze[:sequel].with_meta(meta2) do
      ...
      it "overrides keys in nested blocks" do
        Logidze[:sequel].with_meta(meta) do
          ...
          Logidze[:sequel].with_meta(meta_alt) do
  ...
  describe ".with_responsible" do
    ...
    context "insert" do
      ...
      it "loads responsible when id is string" do
        Logidze[:sequel].with_responsible(responsible.name) do
          expect(subject.reload.responsible_id).to eq responsible.name
        end
      end
      ...
      it "handles block" do
        ...
        Logidze[:sequel].with_responsible(responsible.id, &block)
      ...
      it "handles nil" do
        ...
        Logidze[:sequel].with_responsible(nil, &block)
    ...
    context "update" do
      ...
      it "works with undo/redo" do
        ...
        Logidze[:sequel].with_responsible(responsible2.id) do
          subject.update(name: "updated")
        end
